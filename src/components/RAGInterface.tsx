...
export default function RAGInterface() {
    ...
    const [metodoAtivo, setMetodoAtivo] = useState<'simples' | 'embeddings'>('simples');
            ...
            <div className="max-w-4xl mx-auto">
                <Card className="mb-6">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Faça perguntas sobre os dados do banco e receba respostas inteligentes geradas por IA
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                        {/* Seletor de Método */}
                        <div className="mb-6">
                            <label className="block text-sm font-medium mb-2">Método de Busca:</label>
                ...
                {resposta && (
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Processado com {metodoAtivo === 'simples' ? 'RAG Simples' : 'RAG Embeddings'}
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                            <div className="space-y-4">
                                ...
                                {resposta.dados_consultados && (
                                    <div>
                                        ...
                                        <div className="bg-gray-50 p-3 rounded-lg text-sm">
                                            <p className="mb-2">{resposta.dados_consultados.contexto}</p>
                                            <p>Total de registros: {resposta.dados_consultados.total_registros}</p>
                                        </div>
                                    </div>
                                )}
                                ...
                                {resposta.dados_relevantes && (
                                    <div>
                                        <h4 className="font-semibold mb-2">Dados Mais Relevantes:</h4>
                                                ...
                                                <div key={index} className="bg-gray-50 p-3 rounded-lg text-sm">
                                                    <div className="flex justify-between items-start">
                                                        <div>
                                                            ...
                                                            <p><strong>Valor:</strong> R$ {dado.valor_total}</p>
                                                            <p><strong>Data:</strong> {new Date(dado.data_emissao).toLocaleDateString('pt-BR')}</p>
                                                        </div>
                                ...
                                <div className="text-xs text-gray-500 text-right">
                                    Processado em: {new Date(resposta.timestamp).toLocaleString('pt-BR')}
                                </div>
                            </div>
                        </CardContent>
                    </Card>
